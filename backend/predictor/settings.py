"""
Django settings — Fracture Detection API
"""
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-fracture-detection-dev-key-change-in-prod')
